...
async function loadProfile() {
    ...
    // ✅ SHOW REAL NAME (NOT REGISTER NUMBER)
    setText('profileName', user.full_name || 'Student');

    // ✅ OPTIONAL: SHOW REG NO BELOW NAME
    const regEl = document.getElementById('profileRegNo');
    if (regEl) {
        regEl.textContent = user.dcet_reg_number
            ? `DCET No: ${user.dcet_reg_number}`
            : '';
    }
